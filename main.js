...
document.getElementById("task_of_drawing").innerHTML="Sketch To Be Drawn"+sketch;
timer_counter=0;
timer_check="";
drawn_sketch="";
answer_holder="";
...
if(error)
{
    ...
    document.getElementById("drawing_name").innerHTML="Sketch You Drawn : "+drawn_sketch;
    document.getElementById("drawing_confidence").innerHTML="Confidence : "+Math.round(results[0].confidence*100)+"%";
}
    }
